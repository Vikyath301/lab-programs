...
public class TicketCounterStack {
	public static void main(String[] args) {
        ...
        if (choice == 1) {
            ...
            System.out.println("Invalid initialization choice. Exiting.");
            return;
        }
        int option;
        do {
            ...
            case 1:
                 ...
                 Gender gender1 = Gender.valueOf(sc.next().toUpperCase());
            ...
            case 2:
                 ...
                 System.out.print("Gender (MALE, FEMALE, OTHER): ");
                 Gender gender2_1 = Gender.valueOf(sc.next().toUpperCase());
                 ...
                 System.out.print("Gender (MALE, FEMALE, OTHER): ");
                 Gender gender2_2 = Gender.valueOf(sc.next().toUpperCase());
            ...
            case 3:
                ...
                if (popped != null) popped.display_person();
                break;
